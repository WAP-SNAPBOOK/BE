...
1. [인증 (Auth)](#1-인증-auth)
2. [회원가입 (User)](#2-회원가입-user)
3. [매장 관리 (Shop)](#3-매장-관리-shop)
4. [운영시간 설정 (Schedule)](#4-운영시간-설정-schedule)
5. [휴무일 설정 (Holiday)](#5-휴무일-설정-holiday)
6. [직원 관리 (Staff)](#6-직원-관리-staff)
7. [직원 운영시간 (Staff Operating Times)](#7-직원-운영시간-staff-operating-times)
8. [직원 휴무일 (Staff Holiday)](#8-직원-휴무일-staff-holiday)
9. [태그 관리 (Tag)](#9-태그-관리-tag)
10. [메뉴 관리 (Menu)](#10-메뉴-관리-menu)
11. [메뉴 입력 필드 (Menu Input Field)](#11-메뉴-입력-필드-menu-input-field)
12. [카테고리/태그 용어 매핑](#12-카테고리태그-용어-매핑)
13. [예약 가용성 조회 (Availability)](#13-예약-가용성-조회-availability)
14. [예약 (Reservation)](#14-예약-reservation)
15. [채팅 (Chat)](#15-채팅-chat)
16. [파일 업로드 (File)](#16-파일-업로드-file)
17. [공유 링크 (Link)](#17-공유-링크-link)
