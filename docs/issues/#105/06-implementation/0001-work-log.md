...
- 검증:
  ...
  - `ReservationCreateRequest`, `ReservationResponse`, `ReservationDetailResponse`, `ReservationCustomerResponse`, `ReservationOwnerResponse`, `ReservationService`, `ReservationCreateRequestContractIntegrationTest` 기준 문서 교차 확인.
- 리스크/메모:
...
- 검증:
  - `Reservation`, `ReservationCreateRequest`, `ReservationResponse`, `ReservationDetailResponse`, `ReservationCustomerResponse`, `ReservationOwnerResponse`, `ReservationService` 기준으로 현재 계약 갭 확인.
- 리스크/메모:
